    ...
    <div className="flex flex-col h-full items-center justify-center gap-2">
      ...
      <main
        ...
        <div className="flex flex-col gap-2">
          <div className="flex flex-row justify-center gap-2 mb-1 text-lg">
            <div className="bg-[var(--additional-hint-fill)] px-4 py-1 rounded-full">
              О сериале
            </div>
          </div>
          ...
          <span className="text-left w-full font-[family-name:var(--font-subheader)] text-3xl">Очень странные дела</span>
          <div className="flex flex-row flex-wrap justify-start items-start w-full gap-2
            ...
            <div className="bg-[var(--native-hint-color)] px-2 py-0.5 text-[var(--native-text-color)] rounded-full">
              Сериал
            </div>
