"""Increase data about movies, add some relationship

Revision ID: 9ae32a726dc6
Revises: 01f0dc1b3ed3
Create Date: 2024-11-01 23:54:05.802285
...
def upgrade() -> None:
    ...
    op.add_column('movie', sa.Column('imdb_id', sa.Integer(), nullable=False))
